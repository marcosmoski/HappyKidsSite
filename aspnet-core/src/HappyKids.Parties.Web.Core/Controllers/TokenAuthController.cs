    ...
    public class TokenAuthController : PartiesControllerBase
    {
        ...
        private string CreateAccessToken(IEnumerable<Claim> claims, TimeSpan? expiration = null)
        {
            ...
            try { 
                ...
                Console.Write("Erro ao criar token de acesso");
                return "";
            }            
        }
